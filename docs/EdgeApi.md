...
[**endpoints_id_edge_stacks_stack_id_get**](EdgeApi.md#endpoints_id_edge_stacks_stack_id_get) | **GET** /endpoints/{id}/edge/stacks/{stackId} | Inspect an Edge Stack for an Endpoint
...
api_instance = portainer_ce_api.EdgeApi()
